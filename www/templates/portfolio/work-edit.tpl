				...
				<form method="post" action="<?=HOST?>work-edit?id=<?=$work['id']?>" class="form mb-100 pb-20 pt-35" enctype="multipart/form-data">
					...
					<div class="control-row mt-30">
						<div class="uploaded-image">
							<img class="uploaded-image__img" src="<?=HOST?>usercontent/portfolio/<?=$work['maket_small']?>" alt="<?=$work['title']?>" />
							<div class="uploaded-image__button">
								<input type="submit" name="workDeleteImage" class="button button--del button--small" value="Удалить">
							</div>
						</div>
					</div>
					<?php } ?>
