		...
		<div class="row justify-content-center">
			<div class="col-md-10">
				<div class="blog-full-post">
					...
					<div class="blog__info-wrap"><span class="blog__name">Емельян Казаков</span><span class="blog__travel"><a href="#">Путешествия</a></span>
						<span class="blog__date">
							<?php echo rus_date("j F Y H:i", strtotime($post['date_time'])); ?>
						</span>
						<span class="blog__comments"> <a href="#">2 комментария</a></span></div>
					<div class="blog__image"> <img src="<?=HOST?>usercontent/blog/<?=$post['post_img']?>" alt="<?=$post['title']?>" /></div>
